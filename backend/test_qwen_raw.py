...
try:
    messages = [
        {"role": "system", "content": "You are a precise medical data extraction engine. You specialize in identifying drug names, dosages, and frequencies from noisy OCR text. Only output valid JSON."},
        {"role": "user", "content": prompt}
    ]
    response = ai_service.hf_client.chat_completion(
        messages,
